...
An AI-powered code documentation generator . All AI inference runs **locally in your browser** using on-device LLMs via the RunAnywhere SDK. No cloud APIs. No backend. Zero data transmission.
